...
from special_plot_scripts.appendix_paper_plot_runtime import GAME_TYPE_ABBREVIATIONS
...
APPROXIMATORS_TO_PLOT = [
    ...
    # "ProxySHAP (XGBoost@Depth2, MSR)",
    # "ProxySHAP (XGBoost@Depth4, MSR)",
    # "ProxySHAP (XGBoost@Depth6, MSR)",
    # "ProxySHAP (XGBoost@Depth8, MSR)",
...
APPROXIMATOR_RENAMING = {
    ...
    # ProxySPEX CuttOffs
    "ProxySHAP (XGBoost-Depth2)": "ProxySHAP (XGBoost@Depth2)",
    "ProxySHAP (XGBoost-Depth4)": "ProxySHAP (XGBoost@Depth4)",
    "ProxySHAP (XGBoost-Depth6)": "ProxySHAP (XGBoost@Depth6)",
    "ProxySHAP (XGBoost-Depth8)": "ProxySHAP (XGBoost@Depth8)",
    "ProxySHAP (XGBoost-Depth2, MSR)": "ProxySHAP (XGBoost@Depth2, MSR)",
    "ProxySHAP (XGBoost-Depth4, MSR)": "ProxySHAP (XGBoost@Depth4, MSR)",
    "ProxySHAP (XGBoost-Depth6, MSR)": "ProxySHAP (XGBoost, MSR) [our]",
    "ProxySHAP (XGBoost-Depth8, MSR)": "ProxySHAP (XGBoost@Depth8, MSR)",
    "ProxySPEX (XGBoost-Depth2)": "ProxySPEX (XGBoost@Depth2)",
    "ProxySPEX (XGBoost-Depth4)": "ProxySPEX (XGBoost@Depth4)",
    "ProxySPEX (XGBoost-Depth6)": "ProxySPEX (XGBoost@Depth6)",
    "ProxySPEX (XGBoost-Depth8)": "ProxySPEX (XGBoost@Depth8)",
}
...
if __name__ == "__main__":
    ...
    plot_specs_a4 = [
        {
            "game_name": "TabArenaHelocLocalXAI",
            "order": 2,
            "index": "SII",
    ...
    data_path_template = [
        "results_benchmark_{index}_{order}_{game_type}_tree_depth.csv",
    ...
    plot_combined_main_paper_plots(
        ...
        output_path="plots/appendix/tree_depth_plots.pdf",
