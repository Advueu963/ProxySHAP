...
class ProxySPEX07Truncaction(Sparse):
    """ProxySPEX (SParse EXplainer) via Fourier transform sampling.
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            random_state=random_state,
            transform_type="fourier",
            decoder_type="proxyspex_.7trunjaction",
            degree_parameter=n,
        )


class ProxySPEXNoTruncaction(Sparse):
    """ProxySPEX (SParse EXplainer) via Fourier transform sampling.
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            random_state=random_state,
            transform_type="fourier",
            decoder_type="proxyspex_notrunjaction",
            degree_parameter=n,
        )


class ProxySPEXNoTruncationNoRefinement(Sparse):
    """ProxySPEX (SParse EXplainer) via Fourier transform sampling.
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            random_state=random_state,
            transform_type="fourier",
            decoder_type="proxyspex_notrunjaction_norefinement",
            degree_parameter=n,
        )


class ProxySPEXXGBoost(Sparse):
    """ProxySPEX (SParse EXplainer) via Fourier transform sampling.
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            random_state=random_state,
            transform_type="fourier",
            decoder_type="proxyspex_xgboost_norefinement",
            degree_parameter=n,
...
class ProxySPEXXGBoostNoRefinement(Sparse):
    """ProxySPEX (SParse EXplainer) via Fourier transform sampling.
...
class ProxySPEXXGBoostNoTruncationNoRefinement(Sparse):
    """ProxySPEX (SParse EXplainer) via Fourier transform sampling.
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            random_state=random_state,
            transform_type="fourier",
            decoder_type="proxyspex_xgboost_notrunjaction_norefinement",
            degree_parameter=n,
        )


class ProxySPEXLightGBM(Sparse):
    """ProxySPEX (SParse EXplainer) via Fourier transform sampling.
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            random_state=random_state,
            transform_type="fourier",
            decoder_type="proxyspex_nogridsearch",
            degree_parameter=n,
        )
