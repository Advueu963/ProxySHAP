...
class CoalitionSampler:
        ...
        *,
        ...
        Args:
            ...
            pairing_trick: Samples each coalition jointly with its complement. Defaults to
                ``False``.
            replacement: If ``True``, the sampling is done with replacement. Defaults to
                ``False``.
    ...
    def _reset_variables(self, sampling_budget: int) -> None:
        ...
        # Reset random state to ensure deterministic sampling across repeated calls to sample()
        self.set_random_state(self._random_state)
