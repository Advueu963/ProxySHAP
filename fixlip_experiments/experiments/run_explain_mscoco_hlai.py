...
PATH_INPUT = "../results"
PATH_OUTPUT = "../../storage/ra98xir2/ra98xir2/fixlip_experiments/results/explanations/mscoco"
RANDOM_STATE = 0
    ...
    for mode in [
        ...
        if mode == "banzhaf":
            for approximation_type in [
                ...
                for budget in [100,200,500,100,2000,5000,10000]:
