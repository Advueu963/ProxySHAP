"""Combined main-paper plot script (runtime x-axis).
...
BASE_GENERAL_PARAMS = {
    ...
    "max_budget": 35_000,
    "data_path_template": [
        # Listed in priority order: the first frame wins on any conflicting
        # (game, approximator, budget) row; later frames only add coverage
        # missing from earlier ones.
...
if __name__ == "__main__":
    general_params = {
        **BASE_GENERAL_PARAMS,
        ...
        "perm_sampling_text_x": 0.848,
        "perm_sampling_text_y": 0.45,
    }
    plot_specs = [
        {
    ...
    plot_combined_main_paper_plots(
        ...
        output_path=f"plots/main/main_paper_plots_combined_runtime_modeltime{TIME}.pdf",
        legend_output_path=f"plots/main/main_paper_plots_combined_runtime_modeltime{TIME}_legend.pdf",
        **general_params,
    )
